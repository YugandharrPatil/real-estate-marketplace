								...
								initialData={
									editingProperty
										? {
												...
												latitude: editingProperty.latitude?.toString() || undefined,
												longitude: editingProperty.longitude?.toString() || undefined,
												images: editingProperty.images || undefined,
											}
										: undefined
								}
						...
						{initialProperties.length === 0 ? (
							...
							initialProperties.map((p) => (
								<TableRow key={p.id}>
									...
									<TableCell>
										<Badge variant={statusColor(p.status) as "default" | "secondary" | "destructive"}>{p.status}</Badge>
									</TableCell>
