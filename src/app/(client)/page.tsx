...
import { Building2, MapPin, CalendarCheck, Heart } from "lucide-react";
      ...
      <section className="relative flex items-center justify-center min-h-[70vh] bg-gradient-to-br from-primary/10 via-background to-accent/20 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Browse thousands of listings, schedule visits, and connect directly
            with brokers — all in one modern marketplace.
          </p>
